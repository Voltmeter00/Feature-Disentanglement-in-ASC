...
class ImageClassify(object):
    ...
    def updata_dataloader(self,i):
        ...
        self.train_dataset = dataloader.Load_Data(data_root=config["data_dir"],json_root=config["json_root"].format(i),type="train")
        ...
        self.valid_dataset = dataloader.Load_Data(data_root=config["data_dir"],json_root=config["json_root"].format(i),type="val")
