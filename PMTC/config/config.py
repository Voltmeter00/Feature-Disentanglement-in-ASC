...
feat_training_file = '/share/tyz/ASC_experiments/k_fold/Cross_cd_PMTC/dim_{}_lr{}_batch{}_mcd_{}_grl_{}'.format(data_train_opt["dim"],data_train_opt['lr'],data_train_opt['batch_size'],data_train_opt["mcd"],data_train_opt["grl"])
