...
config["json_root"] = '/home/tyz/ASC_cross/json/cross_cd_mel.json'
config["device_ids"] = [0]
...
data_train_opt["grl"] = 1
feat_training_file = '/share/tyz/ASC_experiments/Cross_cd_PMTC/dim_{}_lr{}_batch{}_mcd_{}_grl_{}'.format(data_train_opt["dim"],data_train_opt['lr'],data_train_opt['batch_size'],data_train_opt["mcd"],data_train_opt["grl"])
final_model_file = os.path.join(feat_training_file,"Final_model.pth")
data_train_opt["acc_log"] = os.path.join(feat_training_file,"acc_log.json")
